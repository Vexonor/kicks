    ...
    return (
        <div onMouseEnter={() => setActive(item)} className="relative">
            <motion.p
                ...
                className="cursor-pointer text-black hover:opacity-[0.9] dark:text-white flex items-center justify-center"
            >
                {item}
            </motion.p>
            {active !== null && (
                ...
                >
                    {active === item && (
                        <div className="absolute top-[calc(100%_+_1.2rem)] left-1/2 transform pt-4">
                            <motion.div
                                transition={transition}
    ...
    return (
        ...
        >
            ...
            <Image
                ...
                alt="Kicks"
            />
            <div className="flex space-x-4 w-60 justify-end gap-x-4">
